...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/mypy-boto3-batch-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=10333&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/mypy-boto3-batch-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `mypy-boto3-batch` can be installed with:

```
conda install mypy-boto3-batch
```

It is possible to list all of the versions of `mypy-boto3-batch` available on your platform with:
